...
public class Cursor extends Entity {
    ...
    public void setup(int x, int y) {
        ...
        scale = 3;
        try {
            BufferedImage up = ImageIO.read(getClass().getResourceAsStream("/Resources/cursor_up.png"));
            BufferedImage down = ImageIO.read(getClass().getResourceAsStream("/Resources/cursor_up.png"));
        } catch (IOException e) {
    ...
    public  void update() {
        ...
        if(!game.input.buttonsLast[1]) {
            ...
            getSprite("/Resources/cursor_down.png");
        }
    }
